  ...
  return (
    ...
    >
        ...
        <div className="absolute top-0 left-0 w-full h-full z-10 pointer-events-none overflow-hidden">
            <div className="absolute top-[10%] left-[10%] w-[500px] h-[500px] bg-emerald-500/20 rounded-full blur-[150px] animate-pulse-slow"></div>
        ...
        <div className="w-full lg:w-[55%] relative z-20 flex flex-col items-center justify-center p-8 lg:p-12 bg-transparent">
            <div className="flex flex-col items-center justify-center w-full animate-in fade-in slide-in-from-left-8 duration-1000">
                <div className="relative w-[350px] h-[350px] md:w-[500px] md:h-[500px] xl:w-[700px] xl:h-[700px] mb-0 group flex items-center justify-center -mt-10">
                    ...
                    <div className="absolute top-[25%] left-[25%] w-[50%] h-[50%] bg-emerald-500/30 rounded-full blur-[100px] group-hover:bg-emerald-500/50 transition-all duration-700 animate-pulse"></div>
                ...
                <h1 
                    className="text-6xl md:text-8xl xl:text-[140px] font-black text-white tracking-[0.25em] uppercase text-center mt-[-60px] xl:mt-[-100px] hover:scale-105 transition-transform duration-500 cursor-default drop-shadow-[0_0_30px_rgba(16,185,129,0.4)]" 
        ...
        <div className="w-full lg:w-[45%] relative z-20 flex flex-col items-center justify-center p-6 lg:p-12 lg:border-l border-emerald-900/40 bg-black/40 backdrop-blur-2xl">
            ...
            <div className="w-full max-w-[440px] flex flex-col items-center justify-center">
                ...
                <div className="w-full bg-[#040D07]/80 rounded-3xl shadow-[0_0_80px_rgba(16,185,129,0.15)] border border-emerald-500/30 p-8 xl:p-12 flex flex-col relative overflow-hidden animate-in fade-in slide-in-from-right-8 duration-700 delay-150 backdrop-blur-3xl">
                    ...
                    <div className="flex flex-col mb-10 text-center items-center">
                        <div className="w-16 h-16 bg-emerald-500/20 rounded-2xl flex items-center justify-center text-emerald-400 border border-emerald-500/40 mb-6 shadow-[0_0_40px_rgba(16,185,129,0.3)] group hover:bg-emerald-500/30 hover:scale-105 transition-all duration-300">
                            <Sparkles size={32} className="animate-pulse" />
                        </div>
                        <h2 className="text-3xl font-bold text-white tracking-tight mb-3 drop-shadow-md" style={{ fontFamily: '"Playfair Display", "Times New Roman", serif', fontStyle: 'italic' }}>
                            {step === 'credentials' ? 'System Authorization' : 'Secure Uplink'}
                        </h2>
                        <p className="text-sm text-emerald-100/60 font-medium tracking-wide uppercase">
                            {step === 'credentials' 
                    ...
                    <div className="flex-1 relative min-h-[220px]">
                        {error && (
                            <div className="mb-6 p-4 rounded-xl bg-red-900/30 border border-red-500/50 flex items-center gap-3 animate-in slide-in-from-top-2 shadow-[0_0_20px_rgba(239,68,68,0.2)]">
                ...
                {/* Footer */}
                <div className="mt-12 text-xs font-bold text-emerald-500/40 text-center uppercase tracking-[0.3em] animate-in fade-in duration-1000 delay-300">
                    My Pipe OS • v3.0.0
                </div>
            </div>
        </div>
