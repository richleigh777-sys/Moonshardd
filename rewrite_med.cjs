    ...
    <div className="space-y-8">
        <div className="grid grid-cols-2 gap-6">
            <div className="space-y-2">
                <label className="text-sm font-medium text-text-secondary ml-1">Height (inches)</label>
                <input 
                    name="height"
                    type="number"
...
fs.writeFileSync('./components/forms/enrollment/sectors/MedicalSector.tsx', content);
console.log('Med done');
