                  ...
                  <div className="flex items-center gap-3 w-full">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      {(group.dosage || group.quantityMultipliers > 1) && (
                        <div className="text-xs font-medium text-text-muted flex gap-2 mt-0.5">
...
fs.writeFileSync('./components/forms/enrollment/CartPreview.tsx', content);
console.log('CartPreview done');
