                ...
                <div className="flex-1 overflow-y-auto custom-scrollbar p-2 space-y-2">
                    <div>
                        ...
                        <textarea 
                            ...
                            className="w-full h-14 bg-surface-alt/40 border border-border-subtle rounded-lg p-2 text-sm font-medium text-text-primary outline-none focus:border-accent-primary focus:bg-surface-main transition-all resize-none shadow-inner leading-tight"
                        />
                    </div>
                        ...
                        {!useShippingForBilling && (
                            <div className="animate-in slide-in-from-top-2 fade-in">
                                ...
                                <textarea 
                                    ...
                                    className="w-full h-12 bg-surface-alt/40 border border-border-subtle rounded-lg p-2 text-sm font-medium text-text-primary outline-none focus:border-accent-primary focus:bg-surface-main transition-all resize-none shadow-inner leading-tight"
                                />
                            </div>
                        )}
                    </div>
