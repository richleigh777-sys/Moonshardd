                            ...
                            <div className="flex items-center gap-2 bg-surface-main/50 px-3 py-1 rounded-lg border border-border-subtle">
                                {grandTotal > 2500 ? (
                                    <>
                                        ...
                                        <span className="text-sm font-medium text-status-warning tracking-wide">HIGH VALUE - AUDIT REQUIRED</span>
                                    </>
                                ) : (
                                    <>
                                        <div className="w-2 h-2 rounded-full bg-emerald-500 animate-pulse"></div>
                                        <span className="text-sm font-medium text-status-success tracking-wide">LOW RISK (98%)</span>
                                    </>
                                )}
                            </div>
                        </div>
