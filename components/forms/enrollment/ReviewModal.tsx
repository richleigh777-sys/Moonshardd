                                    ...
                                    {selectedConditions.length > 0 && (
                                        <div className="mb-6 pt-4 border-t border-border-subtle border-dashed">
                                            ...
                                            <div className="flex flex-wrap gap-1.5">
                                                {selectedConditions.map(c => <span key={c} className="text-sm font-[700]  px-2.5 py-1 bg-surface-main border border-border-subtle rounded text-text-secondary shadow-sm">{c}</span>)}
                                            </div>
                                        </div>
                                    )}
