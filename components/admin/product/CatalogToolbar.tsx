...
export const CatalogToolbar: React.FC<CatalogToolbarProps> = ({
    ...
    return (
        <div className="flex flex-col border-b border-border-subtle bg-surface-alt/30 backdrop-blur-md sticky top-0 z-20">
            <div className="p-5 flex flex-col xl:flex-row justify-between items-center gap-6">
                <div className="flex items-center gap-5 w-full xl:w-auto">
                    <div className="p-3 bg-accent-primary/10 rounded-2xl text-accent-primary border border-accent-primary/20 shadow-neon">
                ...
                <div className="flex flex-wrap items-center gap-3 w-full xl:w-auto">
                    <div className="relative group flex-1 xl:flex-none xl:min-w-[240px]">
                        ...
                        <input autoComplete="off" data-lpignore="true" data-prevent-autofill="true" spellCheck={false} 
                            ...
                            className="w-full bg-surface-main border border-border-subtle rounded-xl py-2.5 pl-10 pr-4 text-xs font-bold outline-none focus:border-accent-primary transition-all shadow-inner"
                        />
                    </div>
