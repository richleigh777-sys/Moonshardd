            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-3 lg:gap-3 relative z-10 w-full">
                <div className="space-y-4 p-4 rounded-xl bg-surface-main/40 border border-border-subtle shadow-inner relative overflow-hidden group/item hover:bg-surface-main/60 transition-colors">
                    ...
                    <div className="flex items-baseline gap-3 relative z-10">
                        ...
                        <span className="text-sm font-medium text-accent-secondary bg-accent-secondary/10 px-2.5 py-1 rounded-lg border border-accent-secondary/20">+5.2%</span>
                    </div>
                    <div className="h-1.5 w-full bg-surface-alt/50 rounded-full overflow-hidden relative z-10 border border-border-subtle">
                        <div className="h-full w-[65%] bg-accent-secondary rounded-full shadow-sm" />
                    </div>
                </div>
                ...
                <div className="space-y-4 p-4 rounded-xl bg-surface-main/40 border border-border-subtle shadow-inner relative overflow-hidden group/item hover:bg-surface-main/60 transition-colors">
                    ...
                    <div className="flex items-baseline gap-3 relative z-10">
                        ...
                        <span className="text-sm font-medium text-status-success bg-status-success/10 px-2.5 py-1 rounded-lg border border-status-success/20">+12.8%</span>
                    </div>
                    <div className="h-1.5 w-full bg-surface-alt/50 rounded-full overflow-hidden relative z-10 border border-border-subtle">
                        <div className="h-full w-[82%] bg-status-success rounded-full shadow-sm" />
                    </div>
                </div>
                ...
                <div className="space-y-4 p-4 rounded-xl bg-surface-main/40 border border-border-subtle shadow-inner relative overflow-hidden group/item hover:bg-surface-main/60 transition-colors">
                    ...
                    <div className="flex items-baseline gap-3 relative z-10">
                        ...
                        <span className="text-sm font-medium text-status-warning bg-status-warning/10 px-2.5 py-1 rounded-lg border border-status-warning/20 shadow-sm animate-pulse">On Track</span>
                    </div>
                    <div className="h-1.5 w-full bg-surface-alt/50 rounded-full overflow-hidden relative z-10 border border-border-subtle">
                        <div className="h-full w-[94%] bg-status-warning rounded-full shadow-sm" />
                    </div>
                </div>
            </div>
        </Card>
