    ...
    return (
        <div className="flex justify-between items-center shrink-0 bg-surface-main/30 backdrop-blur-3xl border border-border-strong p-4 rounded-xl shadow-panel relative overflow-hidden group hover:border-accent-primary/30 transition-all">
            ...
            <div className="flex items-center gap-4 relative z-10">
                <div className={`flex items-center justify-center w-12 h-12 rounded-xl bg-surface-alt/50 border shadow-inner ${isOffline ? 'border-status-error/30 text-status-error shadow-[0_0_15px_var(--color-status-error)]' : 'border-status-success/30 text-status-success shadow-[0_0_15px_var(--color-status-success)]'}`}>
