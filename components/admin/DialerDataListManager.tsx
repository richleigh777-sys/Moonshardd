                                            ...
                                            <tr key={list.id} className="border-b border-border-subtle hover:bg-white/[0.02] transition-colors group">
                                                <td className="p-4 whitespace-nowrap">
                                                    <div className="flex items-center gap-2">
                                                        ...
                                                        <div className="font-mono text-sm group-hover:text-accent-secondary transition-colors truncate max-w-[150px]" title={list.name}>
                                                            {list.name}
                                                        </div>
                                                    </div>
                                                </td>
                                                <td className="p-4">
                                                    <span className="font-mono font-bold text-accent-primary bg-accent-primary/10 px-2 py-1 rounded text-sm border border-accent-primary/20">
