...
export const RosterGrid: React.FC<RosterGridProps> = ({ 
    ...
    return (
        <div className="flex-1 overflow-y-auto custom-scrollbar relative px-2">
             {viewMode === 'list' && (
                 <div className="sticky top-0 z-20 flex justify-between px-4 py-2 bg-surface-main/95 backdrop-blur-md text-[10px] font-bold text-text-muted uppercase tracking-wider border-b border-border-subtle mb-1">
