    ...
    return (
        ...
        >
            ...
            <motion.div variants={itemVariants} className="pt-6 relative group">
                <div className="absolute -inset-1 bg-gradient-to-r from-red-600 to-orange-600 rounded-xl blur-xl opacity-10 group-hover:opacity-30 transition duration-1000"></div>
                <div className="relative bg-[#0f0a0a]/80  rounded-xl p-6 sm:p-8 border border-status-error/30 overflow-hidden shadow-2xl">
                    {/* Hazard Stripes */}
                    ...
                    <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 relative z-10">
                        <div className="flex items-center gap-5">
                            <div className="w-16 h-16 bg-red-500/10 rounded-lg flex items-center justify-center border border-red-500/20 shadow-sm shrink-0 group-hover:bg-red-500/20 transition-colors duration-500">
                                <ServerCrash size={32} className="text-status-error animate-pulse"/>
                            </div>
                            <div>
                                <h4 className="text-xl font-bold text-status-error tracking-tight flex items-center gap-2">
                                    Emergency Flush
                                </h4>
                                <p className="text-sm text-status-error/80 font-bold tracking-wide uppercase mt-1">
                        ...
                        <button 
                            className="h-14 px-8 bg-gradient-to-b from-red-600 to-red-700 hover:from-red-500 hover:to-red-600 text-white rounded-xl text-sm font-bold uppercase tracking-wide shadow-sm flex items-center gap-3 transition-all hover:scale-[1.02] active:scale-[0.98] border border-red-400/30 shrink-0"
                            onClick={() => {
