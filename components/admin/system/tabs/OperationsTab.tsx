    ...
    return (
        <section className="animate-in fade-in slide-in-from-right-4 duration-500 space-y-12">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    ...
                    <div className="space-y-6 p-6 bg-surface-alt/20 rounded-[2rem] border border-border-subtle relative overflow-hidden">
                        ...
                        <div className="relative z-10 space-y-4">
                            <h4 className="text-xs font-black uppercase text-text-primary tracking-widest flex items-center gap-2">
                                <span className="w-2 h-2 rounded-full bg-blue-500"></span> Daily Cycle
                            </h4>
                            
                            <div className="grid grid-cols-2 gap-4">
                                <div className="space-y-1.5">
                                    <label className="text-[9px] font-bold text-text-muted uppercase tracking-wider ml-1">Start Time</label>
                                    <Input 
                                        type="time" 
                                ...
                                <div className="space-y-1.5">
                                    <label className="text-[9px] font-bold text-text-muted uppercase tracking-wider ml-1">End Time</label>
                                    <Input 
                                        type="time" 
                            ...
                            <div className="pt-4 border-t border-border-subtle/50">
                                <div className="flex items-center justify-between p-3 bg-surface-main rounded-xl border border-border-subtle">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div>
                                            <p className="text-[10px] font-black uppercase text-text-primary">Break Allowance</p>
                                            <p className="text-[9px] text-text-muted">Max paid downtime</p>
                                        </div>
                                    </div>
                    ...
                    <div className="space-y-6">
                        <div className="p-6 bg-surface-alt/20 rounded-[2rem] border border-border-subtle space-y-4">
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <div className="space-y-1.5">
                                    <label className="text-[9px] font-bold text-text-muted uppercase tracking-wider ml-1">Cycle 1 Cutoff</label>
                                    <div className="relative group">
                                        <Calendar size={14} className="absolute left-3 top-1/2 -translate-y-1/2 text-text-muted group-focus-within:text-emerald-500 transition-colors" />
                                        <input 
                                            type="number" 
                                        ...
                                        />
                                        <span className="absolute right-3 top-1/2 -translate-y-1/2 text-[9px] font-bold text-text-muted">DAY</span>
                                    </div>
                                </div>
                                <div className="space-y-1.5">
                                    <label className="text-[9px] font-bold text-text-muted uppercase tracking-wider ml-1">Cycle 2 Cutoff</label>
                                    <div className="relative group">
                                        <Calendar size={14} className="absolute left-3 top-1/2 -translate-y-1/2 text-text-muted group-focus-within:text-emerald-500 transition-colors" />
                                        <input 
                                            type="number" 
                            ...
                            <p className="text-[9px] text-text-muted bg-surface-main p-2 rounded-lg border border-border-subtle flex items-center gap-2">
                        ...
                        <div className="p-6 bg-surface-alt/20 rounded-[2rem] border border-border-subtle space-y-4">
                            ...
                            <div className="flex items-center justify-between p-3 bg-surface-main rounded-xl border border-border-subtle">
                                 <div className="flex items-center gap-3">
                                     ...
                                     <div>
                                         <p className="text-[10px] font-black uppercase text-text-primary">Overtime Limit</p>
                                         <p className="text-[9px] text-text-muted">Weekly hour cap</p>
                                     </div>
                                 </div>
                                 <div className="flex items-center gap-2">
                                    <input 
                                    ...
                                    />
                                    <span className="text-[9px] font-bold text-text-muted uppercase">Hrs</span>
                                 </div>
                            </div>
                        </div>
                    </div>
            ...
            <div className="pt-8 border-t border-border-subtle/50">
                <SectionHeader icon={ShieldCheck} title="Data Integrity" sub="Clean Data Protocols & Audit" color="text-emerald-500" />
                ...
                <div className="bg-surface-alt/20 rounded-[2rem] border border-border-subtle p-8 overflow-hidden relative">
                    ...
                    <div className="flex flex-col md:flex-row gap-8 items-center">
                        <div className="space-y-4 max-w-md">
                            <h4 className="text-sm font-black uppercase tracking-widest text-text-primary">Global Ledger Audit</h4>
                            ...
                            <button 
                                onClick={runAudit}
                                disabled={isAuditing}
                                className="px-6 py-3 bg-emerald-500 text-surface-main font-black uppercase text-[10px] tracking-widest rounded-xl hover:brightness-110 active:scale-95 disabled:opacity-50 flex items-center gap-2 transition-all"
                            >
                                {isAuditing ? (
                                    <>
                        ...
                        <div className="flex-1 grid grid-cols-1 sm:grid-cols-2 gap-4 w-full">
                            <div className="p-4 bg-surface-main rounded-2xl border border-border-subtle flex items-center justify-between">
                                <div className="space-y-1">
                                    <p className="text-[8px] font-black text-text-muted uppercase tracking-tighter">Sync Integrity</p>
                                    <p className="text-xl font-black text-emerald-500">{auditResult ? auditResult.score : '--'}%</p>
                                </div>
                                <Database size={24} className="text-emerald-500/20" />
                            </div>
                            <div className="p-4 bg-surface-main rounded-2xl border border-border-subtle relative overflow-hidden">
                                <div className="space-y-2 relative z-10">
                                    <p className="text-[8px] font-black text-text-muted uppercase tracking-tighter">Active Protocols</p>
                                    <div className="flex flex-wrap gap-1">
                                        <span className="px-1.5 py-0.5 bg-blue-500/10 text-blue-500 text-[8px] font-black rounded uppercase">AES-256</span>
                                        <span className="px-1.5 py-0.5 bg-emerald-500/10 text-emerald-500 text-[8px] font-black rounded uppercase">TLS 1.3</span>
                                        <span className="px-1.5 py-0.5 bg-amber-500/10 text-amber-500 text-[8px] font-black rounded uppercase">MFA-ENFORCED</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            {auditResult && (
                                <div className="sm:col-span-2 p-4 bg-red-500/5 border border-red-500/10 rounded-2xl space-y-2 animate-in slide-in-from-top-2 duration-300">
                                    <p className="text-[8px] font-black text-red-500 uppercase flex items-center gap-2">
                                        <AlertCircle size={10} />
