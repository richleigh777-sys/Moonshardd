        ...
        >
            <motion.div variants={cardVariants}>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
                    {/* SHIFT CONFIGURATION */}
                    <div className="space-y-6 p-6 sm:p-8 bg-surface-main/ rounded-[2rem] border border-border-subtle relative overflow-hidden shadow-inner group">
                        ...
                        <div className="relative z-10 space-y-5">
                            <div className="flex justify-between items-center">
                                <h4 className="text-xs font-black text-text-primary tracking-widest flex items-center gap-2 uppercase">
                                    <span className="w-2 h-2 rounded-full bg-[#60A5FA] shadow-[0_0_10px_rgba(96,165,250,0.8)]"></span> Daily Cycle
                                </h4>
                                <span className="text-sm uppercase font-black text-text-muted tracking-widest">Presets Engine</span>
                            </div>

                            {/* Preset Buttons */}
                            <div className="grid grid-cols-4 gap-2 p-1.5 bg-surface-alt rounded-2xl border border-border-subtle shadow-inner">
                            ...
                            <div className="grid grid-cols-2 gap-5">
                                <div className="space-y-2">
                                    <label className="text-sm font-black text-text-muted uppercase tracking-[0.15em] ml-1">Start Time</label>
                                    <Input 
                                        type="time" 
                                ...
                                <div className="space-y-2">
                                    <label className="text-sm font-black text-text-muted uppercase tracking-[0.15em] ml-1">End Time</label>
                                    <Input 
                                        type="time" 
                            ...
                            <div className="pt-5 border-t border-border-subtle">
                                <div className="flex items-center justify-between p-4 bg-surface-alt rounded-2xl border border-border-subtle">
                    ...
                    <div className="space-y-5">
                        <div className="p-6 sm:p-8 bg-surface-main/ rounded-[2rem] border border-border-subtle space-y-5 shadow-inner">
                            <h4 className="text-xs font-black text-text-primary tracking-widest flex items-center gap-2 uppercase">
                                <span className="w-2 h-2 rounded-full bg-[#34D399] shadow-[0_0_10px_rgba(52,211,153,0.8)]"></span> Payroll Cycles
                            </h4>
                            <div className="grid grid-cols-2 gap-5">
                                <div className="space-y-2">
                                    <label className="text-sm font-black text-text-muted uppercase tracking-[0.15em] ml-1">Cycle 1 Cutoff</label>
                                    <div className="relative group">
                                        ...
                                        />
                                        <span className="absolute right-4 top-1/2 -translate-y-1/2 text-sm font-black text-text-muted">DAY</span>
                                    </div>
                                </div>
                                <div className="space-y-2">
                                    <label className="text-sm font-black text-text-muted uppercase tracking-[0.15em] ml-1">Cycle 2 Cutoff</label>
                                    <div className="relative group">
                                        <Calendar size={16} className="absolute left-4 top-1/2 -translate-y-1/2 text-text-muted group-focus-within:text-[#34D399] transition-colors" />
                                        <input autoComplete="off" data-lpignore="true" data-prevent-autofill="true" spellCheck={false} 
                                            type="number" 
                        ...
                        <div className="p-6 sm:p-8 bg-surface-main/ rounded-[2rem] border border-border-subtle space-y-5 shadow-inner">
                             <h4 className="text-xs font-black text-text-primary tracking-widest flex items-center gap-2 uppercase">
                                <span className="w-2 h-2 rounded-full bg-[#F59E0B] shadow-[0_0_10px_rgba(245,158,11,0.8)]"></span> Compliance
                             </h4>
            ...
            <motion.div variants={cardVariants} className="pt-10 border-t border-border-subtle space-y-10 pb-4">
                ...
                <div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-5 gap-6 mt-6">
                        ...
                        {/* REMOTE MANAGEMENT */}
                        <div className="lg:col-span-3 p-8 bg-gradient-to-br from-[#2E1065]/60 to-[#1e1b4b]/20 rounded-[2rem] border border-[#8B5CF6]/20 shadow-[0_0_40px_-15px_rgba(139,92,246,0.15)] relative overflow-hidden group">
                            ...
                            <div className="relative z-10 flex flex-col h-full justify-between">
                                <div>
                                    <h4 className="text-xs font-black text-[#C4B5FD] tracking-widest uppercase flex items-center gap-3 mb-3">
                                ...
                                <div className="space-y-5">
                                    <div className="space-y-2">
                                        <label className="text-sm font-black text-[#C4B5FD]/70 uppercase tracking-[0.15em] ml-1">MCP Webhook Endpoint</label>
                                        <div className="flex gap-2">
                                            <Input 
                                                type="text" 
                                                value={config.companyName === 'MCP_ACTIVE' ? 'https://mcp.nexus-gateway.io/deploy' : 'https://api.system.local/mcp/v1/trigger'}
                                                readOnly
                                                className="font-mono font-medium text-xs bg-surface-main/ border-[#8B5CF6]/30 text-[#C4B5FD] h-12 w-full rounded-xl backdrop-blur-md focus:border-[#8B5CF6]/60 shadow-inner"
                                            />
                                        </div>
                                    </div>
                                    <div className="flex items-center gap-3 flex-wrap pt-4 border-t border-[#8B5CF6]/10">
                                        <span className="text-sm text-[#C4B5FD]/50 font-black uppercase tracking-[0.15em] mr-2">Clients:</span>
                                        <span className="px-3 py-1.5 bg-[#4C1D95]/40 border border-[#8B5CF6]/30 rounded-lg text-sm font-black text-[#DDD6FE] uppercase tracking-wider hover:bg-[#5B21B6]/60 cursor-pointer transition-colors shadow-inner">Claude App</span>
                                        <span className="px-3 py-1.5 bg-[#4C1D95]/40 border border-[#8B5CF6]/30 rounded-lg text-sm font-black text-[#DDD6FE] uppercase tracking-wider hover:bg-[#5B21B6]/60 cursor-pointer transition-colors shadow-inner">Cursor</span>
                                        <span className="px-3 py-1.5 bg-[#4C1D95]/40 border border-[#8B5CF6]/30 rounded-lg text-sm font-black text-[#DDD6FE] uppercase tracking-wider hover:bg-[#5B21B6]/60 cursor-pointer transition-colors shadow-inner">Postman</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        {/* SITE VARIABLES */}
                        <div className="lg:col-span-2 p-8 bg-surface-alt rounded-[2rem] border border-border-subtle shadow-inner relative overflow-hidden flex flex-col justify-between group">
                            ...
                            <div className="relative z-10">
                                <h4 className="text-xs font-black text-text-primary tracking-widest uppercase flex items-center gap-3 mb-3">
                            ...
                            <div className="space-y-3 mt-auto relative z-10">
                                <label className="text-sm font-black text-text-muted uppercase tracking-[0.15em] ml-1 flex items-center gap-2">
                ...
                <motion.div variants={cardVariants}>
                    ...
                    <div className="bg-[#022c22]/30 rounded-[2rem] border border-[#10B981]/20 p-8 sm:p-10 mt-6 overflow-hidden relative shadow-[0_0_50px_-15px_rgba(16,185,129,0.1)] backdrop-blur-3xl">
                        <div className="absolute top-0 left-0 w-full h-[2px] bg-gradient-to-r from-transparent via-[#34D399]/60 to-transparent shadow-[0_0_20px_rgba(52,211,153,0.8)] object-cover blur-[1px]"></div>
                        ...
                        <div className="flex flex-col xl:flex-row gap-10 items-center">
                            ...
                            <div className="space-y-8 max-w-md shrink-0 w-full relative z-10">
                                <div>
                                    ...
                                    <p className="text-sm text-[#A7F3D0]/70 leading-relaxed font-medium">
                                ...
                                <button 
                                    onClick={runAudit}
                                    disabled={isAuditing}
                                    className="w-full h-14 bg-gradient-to-r from-[#10B981] to-[#34D399] hover:from-[#059669] hover:to-[#10B981] text-[#022C22] font-black text-xs uppercase tracking-widest rounded-2xl active:scale-[0.98] disabled:opacity-50 disabled:grayscale flex items-center justify-center gap-3 transition-all shadow-[0_0_30px_-5px_rgba(52,211,153,0.4)] border border-[#6EE7B7]/40"
                                >
                                    {isAuditing ? (
                                        <>
                                ...
                                <div className="space-y-4 pt-6 border-t border-[#10B981]/10">
                                    <p className="text-sm font-black text-[#34D399]/70 uppercase tracking-widest ml-1 mb-2">Active Defense Protocols</p>
                                    <div className="flex flex-col gap-3">
                                        <div className="flex items-center gap-3 p-3.5 rounded-xl bg-[#064E3B]/40 border border-[#10B981]/20 hover:bg-status-success/30 transition-colors shadow-inner">
                                            ...
                                            <span className="text-sm uppercase font-black text-[#D1FAE5] tracking-widest">Cross-Terminal Isolation</span>
                                        </div>
                                        <div className="flex items-center gap-3 p-3.5 rounded-xl bg-[#064E3B]/40 border border-[#10B981]/20 hover:bg-status-success/30 transition-colors shadow-inner">
                                            <div className="p-2 rounded-lg bg-[#3B82F6]/20 text-[#60A5FA]"><Database size={16} /></div>
                                            <span className="text-sm uppercase font-black text-[#D1FAE5] tracking-widest">Zero-Downtime Hydration</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="flex-1 w-full min-w-0 flex flex-col justify-center h-full gap-5 relative z-10">
                                ...
                                <div className="grid grid-cols-2 gap-5">
                                    <div className="p-8 bg-status-success/40 rounded-[2rem] border border-[#10B981]/20 flex flex-col justify-center shadow-inner relative overflow-hidden group">
                                        <div className="absolute inset-0 bg-[#10B981]/5 group-hover:bg-[#10B981]/10 transition-colors duration-500"></div>
                                        <p className="text-sm font-black text-[#A7F3D0]/60 uppercase tracking-widest mb-2 relative z-10">Isolation Health Score</p>
                                        <p className="text-5xl md:text-7xl font-black text-[#6EE7B7] drop-shadow-[0_0_30px_rgba(110,231,183,0.3)] relative z-10 px-1 tracking-tighter">
                                            {auditResult ? auditResult.score + '%' : '--'}
                                        </p>
                                    </div>
                                    <div className="p-8 bg-surface-main/ rounded-[2rem] border border-border-subtle flex flex-col items-center justify-center text-center shadow-inner">
                                ...
                                {isAuditing && (
                                    <motion.div 
                                        ...
                                        className="w-full p-5 bg-status-success/30 rounded-2xl border border-[#10B981]/30 flex items-center justify-between shadow-xl backdrop-blur-md"
                                    >
                                        <div className="flex items-center gap-4">
                                        ...
                                        <div className="h-1.5 w-32 bg-[#022c22] rounded-full overflow-hidden shadow-inner">
                                            <div className="h-full bg-[#34D399] w-full animate-pulse shadow-[0_0_15px_rgba(52,211,153,1)]"></div>
                                        </div>
                                    </motion.div>
                                )}
                                ...
                                {auditResult && !isAuditing && (
                                    <motion.div 
                                        ...
                                        className="w-full p-6 sm:p-8 bg-gradient-to-br from-[#064E3B]/60 to-[#022c22]/90 border border-[#10B981]/30 rounded-3xl space-y-5 shadow-[0_20px_50px_-10px_rgba(2,44,34,0.8)] backdrop-blur-xl relative overflow-hidden"
                                    >
                                        ...
                                        <div className="flex items-center justify-between border-b border-[#10B981]/20 pb-4 relative z-10">
                                            <p className="text-xs font-black uppercase tracking-widest text-[#6EE7B7] flex items-center gap-3">
                                                <div className="p-1.5 rounded-lg bg-[#10B981]/20 border border-[#10B981]/30"><Sparkles size={16} className="text-[#34D399]"/></div>
                                                Diagnostic Report
                                            </p>
                                            <span className="px-3 py-1.5 bg-[#10B981]/20 text-[#6EE7B7] rounded-full text-sm font-black tracking-widest uppercase border border-[#10B981]/30 shadow-inner">Secured</span>
                                        </div>
                                        
                                        <div className="bg-[#022C22]/80 p-5 rounded-2xl border border-[#10B981]/20 font-mono text-xs text-[#A7F3D0] space-y-3 h-[140px] overflow-y-auto custom-scrollbar relative z-10 shadow-inner">
                                            ...
                                            <div className="flex items-start gap-3 pt-4 border-t border-[#10B981]/10 mt-4">
                                                <span className="text-[#059669] shrink-0 font-bold">[{new Date().toISOString().split('T')[1].slice(0,8)}]</span>
                                                <span className="text-[#022C22] font-black bg-[#34D399] px-3 py-1 rounded-md shadow-[0_0_10px_rgba(52,211,153,0.5)]">System boundaries isolated. Node sync optimal.</span>
                                            </div>
                                        </div>
                                        
                                        <button className="w-full h-12 bg-[#022c22]/50 hover:bg-[#10B981]/20 transition-colors text-sm font-black rounded-xl uppercase tracking-widest text-[#6EE7B7] border border-[#10B981]/30 relative z-10 flex items-center justify-center gap-2 group">
