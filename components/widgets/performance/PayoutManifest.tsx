                                        ...
                                        <td className="p-5 text-right">
                                            <div className="flex flex-col items-end">
                                                ...
                                                {item.payout.shippingDeduction > 0 && (
                                                    <span className="text-xs text-status-warning font-bold flex items-center gap-1">
                                        ...
                                        <td className="p-5 text-right">
                                            <div className="flex flex-col items-end gap-1">
                                                {hasSpiff ? (
                                                    ...
                                                    <span className="text-text-muted/50 text-xs font-bold  flex items-center gap-1" title="Thresholds not met for bonus">
                                                        Missed Bonus
                                                    </span>
                                                ) : (
                                                ...
                                                <span className={`text-sm font-bold  tracking-wider ${hasSpiff ? 'text-status-success' : 'text-text-muted/60'}`}>
