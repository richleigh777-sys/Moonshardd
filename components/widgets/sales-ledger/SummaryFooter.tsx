...
export const SummaryFooter: React.FC<SummaryFooterProps> = React.memo(({ 
    ...
    <div className="bg-surface-alt/80 border-t border-border-subtle p-3 flex justify-between items-center text-[10px] font-bold uppercase tracking-widest text-text-muted backdrop-blur-md sticky bottom-0 z-20">
        ...
        <div className="flex gap-4 items-center">
            ...
            <div className="flex gap-2 items-center text-text-primary">
                ...
                <span className="text-sm font-black num-font">${total.toLocaleString(undefined, {minimumFractionDigits: 2, maximumFractionDigits: 2})}</span>
            </div>
        </div>
