            ...
            <div className="flex items-center gap-3 w-full xl:w-auto justify-between xl:justify-end">
                <div className="flex items-center gap-2">
                    ...
                    <button 
                        ...
                        className={`px-3 py-2 rounded-xl border text-xs font-[700]  tracking-wider transition-all ${viewOwn ? 'bg-surface-main text-text-primary border-accent-primary shadow-sm' : 'bg-surface-alt text-text-muted border-border-subtle hover:text-text-primary'}`}
                    >
                ...
                <div className="flex flex-col items-end hidden md:flex">
                    ...
                    <span className="text-sm font-[700] text-status-success num-font flex items-center gap-1">
