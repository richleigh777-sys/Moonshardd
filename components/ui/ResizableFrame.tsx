        ...
        >
            ...
            {isSuperAdmin && (
                <>
                    ...
                    {/* 2. Holographic HUD */}
                    {isResizing && (
                        <div className={`absolute top-4 right-4 z-[60] backdrop-blur-xl border px-4 py-2.5 rounded-xl shadow-2xl flex items-center gap-4 animate-in fade-in zoom-in duration-200 pointer-events-none select-none ${isSnapped ? 'bg-emerald-950/80 border-status-success/50 text-status-success' : 'bg-black/80 border-accent-primary/50 text-accent-primary'}`}>
                            ...
                            <div className="flex flex-col">
                                <span className="text-xs font-[700]  tracking-widest opacity-70 flex justify-between gap-4">
                                    ...
                                    {isSnapped && <span className="text-status-success">MAGNETIC LOCK</span>}
                                </span>
                    ...
                    >
                        {direction === 'vertical' ? (
                            ...
                            <div className="w-full h-full relative">
                                ...
                                {/* Keyboard Hint */}
                                <div className="absolute bottom-1 right-1 opacity-0 group-focus:opacity-100 transition-opacity text-sm text-accent-primary font-[700] -translate-x-full pr-2 whitespace-nowrap pointer-events-none">
                                    USE ARROWS
                                </div>
                            </div>
                        )}
