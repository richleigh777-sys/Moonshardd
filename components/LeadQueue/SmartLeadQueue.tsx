      ...
      <div className="max-w-6xl mx-auto">
        <div className="flex flex-col sm:flex-row sm:items-end justify-between mb-8 gap-4">
           ...
           <button 
             ...
             className="px-4 py-2.5 bg-surface-main text-accent-primary font-bold text-sm uppercase tracking-wider rounded-xl border border-border-subtle shadow-sm hover:shadow-panel disabled:opacity-50 transition-all flex items-center justify-center cursor-pointer"
           >
