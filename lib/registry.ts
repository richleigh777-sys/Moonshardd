...
export const GLOBAL_REGISTRY: RegistryField[] = [
    ...
    { key: 'height', label: 'Height', category: 'identity', type: 'string', synonyms: ['tall', 'height'], icon: Activity, width: '80px' },
    { key: 'weight', label: 'Weight', category: 'identity', type: 'string', synonyms: ['mass', 'weight', 'lbs'], icon: Activity, width: '80px' },
